          ...
          <div id="ingredients" className="scroll-mt-24 flex flex-col gap-10">
            ...
            <FadeIn delay={0.15}>
              <div className="relative">
                <div className="flex items-center justify-center lg:justify-start gap-2 sm:gap-3 overflow-x-auto pb-2 -mx-6 px-6 lg:mx-0 lg:px-0 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
                  {ingredients.map((ingredient, index) => (
                    <div key={ingredient.key} className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
                      <div className="flex flex-col items-center gap-2 text-center w-14 sm:w-16">
                        <div className="relative w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-white border border-line overflow-hidden flex-shrink-0">
                          <Image
                ...
                <div className="pointer-events-none absolute inset-y-0 right-0 w-10 bg-gradient-to-l from-beige to-transparent lg:hidden" />
              </div>
            </FadeIn>
